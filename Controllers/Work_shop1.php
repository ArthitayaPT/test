...
class Work_shop1 extends BaseController {
    ...
    public function update_student() {
        ...
        // แก้ไขข้อมูลนักเรียน
        $m_stud = new M_student();
        $m_stud->update_student($student_id, $student_number, $student_prefix_id, $student_firstname, $student_lastname, $student_birthdate, $student_mail, $student_year, $student_cluster_id, $student_image_name, $student_pdf_name, $student_address);
